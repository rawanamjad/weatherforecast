//using Appsfactory.Weather.WeatherForecast.ApplicationDomain.Entities;
    ...
    public class WeatherForecastService : IWeatherForecastService
    {
       ...
       //const apiUrl = "https://api.openweathermap.org/data/2.5/";
        ...
        public async Task<WeatherForecastResponse> GetWeatherForecastByCity(string city)
        {
           ...
           "https://api.openweathermap.org/data/2.5/weather?appid=fcadd28326c90c3262054e0e6ca599cd&q={city}");
